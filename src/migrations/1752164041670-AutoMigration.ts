...
export class AutoMigration1752164041670 implements MigrationInterface {
    name = 'AutoMigration1752164041670'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`equipamentos\` ADD \`observacao\` varchar(255) NOT NULL`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`equipamentos\` DROP COLUMN \`observacao\``);
